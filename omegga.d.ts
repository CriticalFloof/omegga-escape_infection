...
export declare type EnvironmentPreset = Preset<
    "Environment",
    {
        groups?: {
            Sky?: {
...
export declare type UnrealTypeFromString<T> = T extends "Class"
    ? UnrealClass
    : T extends "Object"
    ? UnrealObject
    : T extends "Boolean"
...
export declare type BrickV9 = Modify<
    BrickV8,
    {
...
>;
export declare type BrickV10 = Modify<
    BrickV9,
    {
        collision: Collision;
    }
...
export declare type BrsV2 = Modify<
    BrsV1,
    {
        version: 2;
        materials: string[];
...
>;
export declare type BrsV3 = Modify<
    BrsV2,
    {
        version: 3;
        brick_owners: User[];
...
>;
export declare type BrsV4 = Modify<
    BrsV3,
    {
        version: 4;
...
>;
export declare type BrsV8 = Modify<
    BrsV4,
    {
        version: 8;
        host: User;
...
>;
export declare type BrsV9 = Modify<
    BrsV8,
    {
        version: 9;
...
>;
export declare type BrsV10 = Modify<
    BrsV9,
    {
        version: 10;
        bricks: BrickV10[];
...
declare function getBrickSize(brick: Brick, brick_assets: string[]): [number, number, number];
declare function getScaleAxis(brick: Brick, axis: number): number;
declare function setOwnership(
    player: {
        id: string;
        name: string;
    },
...
declare function rotate(brick: Brick, rotation: [number, number]): Brick;
...
export declare const _OMEGGA_UTILS_IMPORT: {
    ...
    time: {
        ...
        debounce:
            | (<T_1 extends (...args: any) => any>(func: T_1, wait: number, options?: DebounceSettingsLeading) => DebouncedFuncLeading<T_1>)
            | (<T_2 extends (...args: any) => any>(func: T_2, wait?: number, options?: DebounceSettings) => DebouncedFunc<T_2>);
    };
    map: {
        DEFAULT_MAPS: {
            name: string;
    ...
    brick: {
        BRICK_CONSTANTS: {
            ...
            translationTable: (([x, y, z]: [number, number, number]) => [number, number, number])[];
            orientationMap: Record<string, [number, number]>;
            DEFAULT_MATERIALS: string[];
            brickSizeMap: Record<string, [number, number, number]>;
        };
...
export interface OmeggaCore {
     ...
     */
    getSaveData(region?: { center: [number, number, number]; extent: [number, number, number] }): Promise<ReadSaveObject>;
    /**
     * Change server map
     * @param map Map name
     */
...
export interface LogWrangling {
    ...
    watchLogArray<Item extends Record<string, string> = Record<string, string>, Member extends Record<string, string> = Record<string, string>>(
        cmd: string,
        itemPattern: RegExp,
...
export declare type WeaponClass =
